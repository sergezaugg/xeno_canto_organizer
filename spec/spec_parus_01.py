...
xc = xco.XCO(start_path = 'C:/xc_real_projects/xc_parus_02')
...
df_records = xc.get_summary(params_json = 'download_parus_real.json')
...
df_records.shape
sel = df_records['smp'].astype(int)>= 24000
df_records = df_records[sel]
df_records.shape
...
xc.extract_spectrograms(target_fs = 24000, segm_duration = 0.394 , segm_step = 0.80, win_siz = 256, win_olap = 220.5, max_segm_per_file = 12, equalize = True, colormap='gray')
