...
xc = xco.XCO(start_path = 'C:/xc_real_projects/xc_streamlit_sw_eur')
...
df_records = xc.get_summary(params_json = 'download_sw_europe_mini.json')
# make summary tables 
...
# Make rectangular spectrogram with size = 128 freq x 256 time and 1 channel
