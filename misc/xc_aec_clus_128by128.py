...
xc = xco.XCO(start_path = 'C:/xc_real_projects/xc_aec_project_test')
...
xc.get(params_json = 'xc_aec_proj_test.json', download = False)
# download mp3 files with metadata  
xc.get(params_json = 'xc_aec_proj_test.json', download = True)
