...
xc.extract_spectrograms(target_sampl_freq = 21568, duratSec = 0.5, win_siz = 128, win_olap = 100, seg_step_size = 1.0, colormap = 'viridis')
xc.extract_spectrograms(target_sampl_freq = 8000, duratSec = 0.5, win_siz = 116, win_olap = 64, seg_step_size = 0.75, colormap = 'viridis')
xc.extract_spectrograms(target_sampl_freq = 1024, duratSec = 0.5, win_siz = 64, win_olap = 63, seg_step_size = 1.5, colormap = 'viridis')
